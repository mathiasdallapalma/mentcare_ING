...
|**Flow**| L'utente tramite la pagina del paziente utilizza il bottone “aggiungi prescrizione” nella sezione della prescrizione per aggiungere i medicinali e/o trattamenti che un paziente deve seguire. Il sistema  reindirizza la navigazione alla pagina di inserimento. L'utente tramite il form può aggiungere nuovi medicinali. Tramite bottoni i "accetta" e "annulla" può confermare o annullare l'operazione. |
